...
* <pre>
* var SmartWorksSdk = require('index'); // See note below*.
* var xxxSvc = new SmartWorksSdk.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new SmartWorksSdk.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new SmartWorksSdk.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new SmartWorksSdk.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
