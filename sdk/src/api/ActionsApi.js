...
export default class ActionsApi {
    ...
    */
     ...
     */
    addActionWithHttpInfo(space, collectionName, thingId, action, requestBody) {
     ...
     */
    addAction(space, collectionName, thingId, action, requestBody) {
      return this.addActionWithHttpInfo(space, collectionName, thingId, action, requestBody)
     ...
     */
    updateActionWithHttpInfo(space, collectionName, thingId, action, actionId, requestBody) {
      let postBody = requestBody;
      // verify the required parameter 'space' is set
      if (space === undefined || space === null) {
     ...
     */
    updateAction(space, collectionName, thingId, action, actionId, requestBody) {
      return this.updateActionWithHttpInfo(space, collectionName, thingId, action, actionId, requestBody)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
