...
export default class OAuthApi {
    ...
    */
     ...
     */
    getOauth2AuthWithHttpInfo(clientId, responseType, responseMode, redirectUri, state, scope, codeChallengeMethod, codeChallenge, opts) {
      opts = opts || {};
      let postBody = null;
    ...
    getOauth2Auth(clientId, responseType, responseMode, redirectUri, state, scope, codeChallengeMethod, codeChallenge, opts) {
      return this.getOauth2AuthWithHttpInfo(clientId, responseType, responseMode, redirectUri, state, scope, codeChallengeMethod, codeChallenge, opts)
     ...
     */
    getOauth2TokenWithHttpInfo(grantType, clientId, clientSecret, code, codeVerifier, refreshToken, redirectUri, scope) {
      let postBody = null;
     ...
     */
    getOauth2Token(grantType, clientId, clientSecret, code, codeVerifier, refreshToken, redirectUri, scope) {
      return this.getOauth2TokenWithHttpInfo(grantType, clientId, clientSecret, code, codeVerifier, refreshToken, redirectUri, scope)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    getOpenIdSessionsLogoutWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
    ...
    getOpenIdSessionsLogout(opts) {
      return this.getOpenIdSessionsLogoutWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    getOpenIdUserInfoWithHttpInfo() {
      ...
      let authNames = ['AccessToken', 'OAuth2AuthorizationCode', 'OAuth2ClientCredentials', 'OAuth2Security', 'OAuth2Security', 'bearerAuth'];
      let contentTypes = [];
      let accepts = ['application/jwt', 'application/json'];
      let returnType = null;
      return this.apiClient.callApi(
        '/userinfo', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
     ...
     */
    getOpenIdUserInfo() {
      return this.getOpenIdUserInfoWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    postOauth2RevokeWithHttpInfo(token, clientId, clientSecret) {
      let postBody = null;
    ...
    postOauth2Revoke(token, clientId, clientSecret) {
      return this.postOauth2RevokeWithHttpInfo(token, clientId, clientSecret)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
