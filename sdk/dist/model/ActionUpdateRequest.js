...
var _ActionUpdateRequestDelay = _interopRequireDefault(require("./ActionUpdateRequestDelay"));
 ...
 * @version 1.0.0
 */
var ActionUpdateRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ActionUpdateRequest</code>.
   * @alias module:model/ActionUpdateRequest
   * @extends Object
   */
  function ActionUpdateRequest() {
    _classCallCheck(this, ActionUpdateRequest);
  ...
  _createClass(ActionUpdateRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('delay')) {
          obj['delay'] = _ActionUpdateRequestDelay["default"].constructFromObject(data['delay']);
        }
      }
...
var _default = ActionUpdateRequest;
