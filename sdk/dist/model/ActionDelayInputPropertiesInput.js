 ...
 * @version 0.8.12
 */
var ActionDelayInputPropertiesInput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ActionDelayInputPropertiesInput</code>.
   * @alias module:model/ActionDelayInputPropertiesInput
   */
  function ActionDelayInputPropertiesInput() {
    _classCallCheck(this, ActionDelayInputPropertiesInput);
  ...
  _createClass(ActionDelayInputPropertiesInput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('maximum')) {
          obj['maximum'] = _ApiClient["default"].convertToType(data['maximum'], 'Number');
        }

        if (data.hasOwnProperty('minimum')) {
          obj['minimum'] = _ApiClient["default"].convertToType(data['minimum'], 'Number');
        }
  ...
  return ActionDelayInputPropertiesInput;
}();
/**
...
var _default = ActionDelayInputPropertiesInput;
