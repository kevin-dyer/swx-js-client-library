 ...
 * @version 1.0.0
 */
var ThingDeleteResponseErrorClusterBackend = /*#__PURE__*/function () {
  /**
   ...
   */
  function ThingDeleteResponseErrorClusterBackend() {
    _classCallCheck(this, ThingDeleteResponseErrorClusterBackend);
  ...
  _createClass(ThingDeleteResponseErrorClusterBackend, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('http_status_code')) {
          obj['http_status_code'] = _ApiClient["default"].convertToType(data['http_status_code'], 'Number');
        }
      }
  ...
  return ThingDeleteResponseErrorClusterBackend;
}();
/**
...
var _default = ThingDeleteResponseErrorClusterBackend;
