...
var _BaseErrorError = _interopRequireDefault(require("./BaseErrorError"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _BaseErrorError["default"].constructFromObject(data['error']);
        }
      }
...
BaseError.prototype['error'] = undefined;
