...
var _BadFormedErrorError = _interopRequireDefault(require("./BadFormedErrorError"));
 ...
 * @version 1.0.0
 */
var BadFormedError = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BadFormedError</code>.
   * @alias module:model/BadFormedError
   */
  function BadFormedError() {
    _classCallCheck(this, BadFormedError);
  ...
  _createClass(BadFormedError, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _BadFormedErrorError["default"].constructFromObject(data['error']);
        }
      }
