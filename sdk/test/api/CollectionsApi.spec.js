...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.CollectionsApi();
  });
  ...
  describe('CollectionsApi', function() {
    ...
    describe('showCollection', function() {
      it('should call showCollection successfully', function(done) {
        //uncomment below and update the code to test showCollection
        //instance.showCollection(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
