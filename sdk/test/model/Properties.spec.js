...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.Properties();
  });
  ...
  describe('Properties', function() {
    it('should create an instance of Properties', function() {
      ...
      //var instane = new SmartWorksSdk.Properties();
      //expect(instance).to.be.a(SmartWorksSdk.Properties);
    });

    it('should have the property cpu (base name: "cpu")', function() {
      // uncomment below and update the code to test the property cpu
      //var instance = new SmartWorksSdk.Properties();
