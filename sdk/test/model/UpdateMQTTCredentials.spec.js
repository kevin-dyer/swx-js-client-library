...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.UpdateMQTTCredentials();
  });
  ...
  describe('UpdateMQTTCredentials', function() {
    it('should create an instance of UpdateMQTTCredentials', function() {
      ...
      //var instane = new SmartWorksSdk.UpdateMQTTCredentials();
      //expect(instance).to.be.a(SmartWorksSdk.UpdateMQTTCredentials);
    });

    it('should have the property username (base name: "username")', function() {
      // uncomment below and update the code to test the property username
      //var instance = new SmartWorksSdk.UpdateMQTTCredentials();
