...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ActionResponseElement1Delay();
  });
  ...
  describe('ActionResponseElement1Delay', function() {
    it('should create an instance of ActionResponseElement1Delay', function() {
      ...
      //var instane = new DigitalModelApiWip.ActionResponseElement1Delay();
      //expect(instance).to.be.a(DigitalModelApiWip.ActionResponseElement1Delay);
    });

    it('should have the property input (base name: "input")', function() {
      // uncomment below and update the code to test the property input
      //var instance = new DigitalModelApiWip.ActionResponseElement1Delay();
