...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ActionReboot();
  });
  ...
  describe('ActionReboot', function() {
    it('should create an instance of ActionReboot', function() {
      ...
      //var instane = new MqttApiReference.ActionReboot();
      //expect(instance).to.be.a(MqttApiReference.ActionReboot);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new MqttApiReference.ActionReboot();
