...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.ActionReboot();
  });
  ...
  describe('ActionReboot', function() {
    it('should create an instance of ActionReboot', function() {
      ...
      //var instane = new SmartWorksSdk.ActionReboot();
      //expect(instance).to.be.a(SmartWorksSdk.ActionReboot);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new SmartWorksSdk.ActionReboot();
