...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.CollectionUpdateResponse();
  });
  ...
  describe('CollectionUpdateResponse', function() {
    it('should create an instance of CollectionUpdateResponse', function() {
      ...
      //var instane = new DigitalModelApiWip.CollectionUpdateResponse();
      //expect(instance).to.be.a(DigitalModelApiWip.CollectionUpdateResponse);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new DigitalModelApiWip.CollectionUpdateResponse();
