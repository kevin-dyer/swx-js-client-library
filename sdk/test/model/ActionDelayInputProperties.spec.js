...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ActionDelayInputProperties();
  });
  ...
  describe('ActionDelayInputProperties', function() {
    it('should create an instance of ActionDelayInputProperties', function() {
      ...
      //var instane = new DigitalModelApiWip.ActionDelayInputProperties();
      //expect(instance).to.be.a(DigitalModelApiWip.ActionDelayInputProperties);
    });

    it('should have the property input (base name: "input")', function() {
      // uncomment below and update the code to test the property input
      //var instance = new DigitalModelApiWip.ActionDelayInputProperties();
