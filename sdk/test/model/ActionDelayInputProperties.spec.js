...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ActionDelayInputProperties();
  });
  ...
  describe('ActionDelayInputProperties', function() {
    it('should create an instance of ActionDelayInputProperties', function() {
      ...
      //var instane = new MqttApiReference.ActionDelayInputProperties();
      //expect(instance).to.be.a(MqttApiReference.ActionDelayInputProperties);
    });

    it('should have the property input (base name: "input")', function() {
      // uncomment below and update the code to test the property input
      //var instance = new MqttApiReference.ActionDelayInputProperties();
