...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.EventHighCPUListResponse();
  });
  ...
  describe('EventHighCPUListResponse', function() {
    it('should create an instance of EventHighCPUListResponse', function() {
      ...
      //var instane = new MqttApiReference.EventHighCPUListResponse();
      //expect(instance).to.be.a(MqttApiReference.EventHighCPUListResponse);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new MqttApiReference.EventHighCPUListResponse();
