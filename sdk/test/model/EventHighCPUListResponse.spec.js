...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.EventHighCPUListResponse();
  });
  ...
  describe('EventHighCPUListResponse', function() {
    it('should create an instance of EventHighCPUListResponse', function() {
      ...
      //var instane = new SmartWorksSdk.EventHighCPUListResponse();
      //expect(instance).to.be.a(SmartWorksSdk.EventHighCPUListResponse);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new SmartWorksSdk.EventHighCPUListResponse();
