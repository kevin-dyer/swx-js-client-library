...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.TriggerRabbitMQConfig();
  });
  ...
  describe('TriggerRabbitMQConfig', function() {
    it('should create an instance of TriggerRabbitMQConfig', function() {
      ...
      //var instane = new SmartWorksSdk.TriggerRabbitMQConfig();
      //expect(instance).to.be.a(SmartWorksSdk.TriggerRabbitMQConfig);
    });

    it('should have the property host (base name: "host")', function() {
      // uncomment below and update the code to test the property host
      //var instance = new SmartWorksSdk.TriggerRabbitMQConfig();
