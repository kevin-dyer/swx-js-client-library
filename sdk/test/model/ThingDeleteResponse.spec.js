...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ThingDeleteResponse();
  });
  ...
  describe('ThingDeleteResponse', function() {
    it('should create an instance of ThingDeleteResponse', function() {
      ...
      //var instane = new MqttApiReference.ThingDeleteResponse();
      //expect(instance).to.be.a(MqttApiReference.ThingDeleteResponse);
    });
    ...
    it('should have the property errorClusterBackend (base name: "error_cluster_backend")', function() {
      ...
      //var instance = new MqttApiReference.ThingDeleteResponse();
