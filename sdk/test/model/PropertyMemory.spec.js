...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.PropertyMemory();
  });
  ...
  describe('PropertyMemory', function() {
    it('should create an instance of PropertyMemory', function() {
      ...
      //var instane = new SmartWorksSdk.PropertyMemory();
      //expect(instance).to.be.a(SmartWorksSdk.PropertyMemory);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new SmartWorksSdk.PropertyMemory();
