...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.LogEntry();
  });
  ...
  describe('LogEntry', function() {
    it('should create an instance of LogEntry', function() {
      ...
      //var instane = new SmartWorksSdk.LogEntry();
      //expect(instance).to.be.a(SmartWorksSdk.LogEntry);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SmartWorksSdk.LogEntry();
