...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.LogEntry();
  });
  ...
  describe('LogEntry', function() {
    it('should create an instance of LogEntry', function() {
      ...
      //var instane = new MqttApiReference.LogEntry();
      //expect(instance).to.be.a(MqttApiReference.LogEntry);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MqttApiReference.LogEntry();
