...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.CredentialsStudio();
  });
  ...
  describe('CredentialsStudio', function() {
    it('should create an instance of CredentialsStudio', function() {
      ...
      //var instane = new MqttApiReference.CredentialsStudio();
      //expect(instance).to.be.a(MqttApiReference.CredentialsStudio);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MqttApiReference.CredentialsStudio();
