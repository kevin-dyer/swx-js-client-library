...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ActionRequestDelayInput();
  });
  ...
  describe('ActionRequestDelayInput', function() {
    it('should create an instance of ActionRequestDelayInput', function() {
      ...
      //var instane = new MqttApiReference.ActionRequestDelayInput();
      //expect(instance).to.be.a(MqttApiReference.ActionRequestDelayInput);
    });

    it('should have the property delay (base name: "delay")', function() {
      // uncomment below and update the code to test the property delay
      //var instance = new MqttApiReference.ActionRequestDelayInput();
