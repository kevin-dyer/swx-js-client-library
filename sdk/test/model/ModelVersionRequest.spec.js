...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ModelVersionRequest();
  });
  ...
  describe('ModelVersionRequest', function() {
    it('should create an instance of ModelVersionRequest', function() {
      ...
      //var instane = new DigitalModelApiWip.ModelVersionRequest();
      //expect(instance).to.be.a(DigitalModelApiWip.ModelVersionRequest);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new DigitalModelApiWip.ModelVersionRequest();
