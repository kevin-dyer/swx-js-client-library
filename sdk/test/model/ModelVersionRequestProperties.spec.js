...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ModelVersionRequestProperties();
  });
  ...
  describe('ModelVersionRequestProperties', function() {
    it('should create an instance of ModelVersionRequestProperties', function() {
      // uncomment below and update the code to test ModelVersionRequestProperties
      //var instane = new MqttApiReference.ModelVersionRequestProperties();
      //expect(instance).to.be.a(MqttApiReference.ModelVersionRequestProperties);
    });

    it('should have the property cpu (base name: "cpu")', function() {
      // uncomment below and update the code to test the property cpu
      //var instance = new MqttApiReference.ModelVersionRequestProperties();
