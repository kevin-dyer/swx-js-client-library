...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.Trigger();
  });
  ...
  describe('Trigger', function() {
    it('should create an instance of Trigger', function() {
      ...
      //var instane = new MqttApiReference.Trigger();
      //expect(instance).to.be.a(MqttApiReference.Trigger);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MqttApiReference.Trigger();
