...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.Trigger();
  });
  ...
  describe('Trigger', function() {
    it('should create an instance of Trigger', function() {
      ...
      //var instane = new SmartWorksSdk.Trigger();
      //expect(instance).to.be.a(SmartWorksSdk.Trigger);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new SmartWorksSdk.Trigger();
