...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.Secret();
  });
  ...
  describe('Secret', function() {
    it('should create an instance of Secret', function() {
      ...
      //var instane = new DigitalModelApiWip.Secret();
      //expect(instance).to.be.a(DigitalModelApiWip.Secret);
    });
    ...
    it('should have the property clientSecret (base name: "client_secret")', function() {
      ...
      //var instance = new DigitalModelApiWip.Secret();
