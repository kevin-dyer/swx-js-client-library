...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.Secret();
  });
  ...
  describe('Secret', function() {
    it('should create an instance of Secret', function() {
      ...
      //var instane = new SmartWorksSdk.Secret();
      //expect(instance).to.be.a(SmartWorksSdk.Secret);
    });
    ...
    it('should have the property clientSecret (base name: "client_secret")', function() {
      ...
      //var instance = new SmartWorksSdk.Secret();
