...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.Secret();
  });
  ...
  describe('Secret', function() {
    it('should create an instance of Secret', function() {
      ...
      //var instane = new MqttApiReference.Secret();
      //expect(instance).to.be.a(MqttApiReference.Secret);
    });
    ...
    it('should have the property clientSecret (base name: "client_secret")', function() {
      ...
      //var instance = new MqttApiReference.Secret();
