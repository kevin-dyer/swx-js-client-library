...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ThingStatusResponse();
  });
  ...
  describe('ThingStatusResponse', function() {
    it('should create an instance of ThingStatusResponse', function() {
      ...
      //var instane = new DigitalModelApiWip.ThingStatusResponse();
      //expect(instance).to.be.a(DigitalModelApiWip.ThingStatusResponse);
    });

    it('should have the property uid (base name: "uid")', function() {
      // uncomment below and update the code to test the property uid
      //var instance = new DigitalModelApiWip.ThingStatusResponse();
