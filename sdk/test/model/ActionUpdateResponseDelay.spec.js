...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ActionUpdateResponseDelay();
  });
  ...
  describe('ActionUpdateResponseDelay', function() {
    it('should create an instance of ActionUpdateResponseDelay', function() {
      ...
      //var instane = new MqttApiReference.ActionUpdateResponseDelay();
      //expect(instance).to.be.a(MqttApiReference.ActionUpdateResponseDelay);
    });

    it('should have the property input (base name: "input")', function() {
      // uncomment below and update the code to test the property input
      //var instance = new MqttApiReference.ActionUpdateResponseDelay();
