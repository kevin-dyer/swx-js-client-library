...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ActionUpdateResponseDelay();
  });
  ...
  describe('ActionUpdateResponseDelay', function() {
    it('should create an instance of ActionUpdateResponseDelay', function() {
      ...
      //var instane = new DigitalModelApiWip.ActionUpdateResponseDelay();
      //expect(instance).to.be.a(DigitalModelApiWip.ActionUpdateResponseDelay);
    });

    it('should have the property input (base name: "input")', function() {
      // uncomment below and update the code to test the property input
      //var instance = new DigitalModelApiWip.ActionUpdateResponseDelay();
