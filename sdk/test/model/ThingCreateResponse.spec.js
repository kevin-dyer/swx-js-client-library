...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ThingCreateResponse();
  });
  ...
  describe('ThingCreateResponse', function() {
    it('should create an instance of ThingCreateResponse', function() {
      ...
      //var instane = new MqttApiReference.ThingCreateResponse();
      //expect(instance).to.be.a(MqttApiReference.ThingCreateResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MqttApiReference.ThingCreateResponse();
