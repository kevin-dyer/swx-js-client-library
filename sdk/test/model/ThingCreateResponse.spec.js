...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ThingCreateResponse();
  });
  ...
  describe('ThingCreateResponse', function() {
    it('should create an instance of ThingCreateResponse', function() {
      // uncomment below and update the code to test ThingCreateResponse
      //var instane = new DigitalModelApiWip.ThingCreateResponse();
      //expect(instance).to.be.a(DigitalModelApiWip.ThingCreateResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new DigitalModelApiWip.ThingCreateResponse();
