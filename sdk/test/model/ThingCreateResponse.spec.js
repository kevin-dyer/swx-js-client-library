...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartWorksSdk.ThingCreateResponse();
  });
  ...
  describe('ThingCreateResponse', function() {
    it('should create an instance of ThingCreateResponse', function() {
      ...
      //var instane = new SmartWorksSdk.ThingCreateResponse();
      //expect(instance).to.be.a(SmartWorksSdk.ThingCreateResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new SmartWorksSdk.ThingCreateResponse();
