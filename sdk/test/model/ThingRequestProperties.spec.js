...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ThingRequestProperties();
  });
  ...
  describe('ThingRequestProperties', function() {
    it('should create an instance of ThingRequestProperties', function() {
      ...
      //var instane = new DigitalModelApiWip.ThingRequestProperties();
      //expect(instance).to.be.a(DigitalModelApiWip.ThingRequestProperties);
    });

    it('should have the property cpu (base name: "cpu")', function() {
      // uncomment below and update the code to test the property cpu
      //var instance = new DigitalModelApiWip.ThingRequestProperties();
