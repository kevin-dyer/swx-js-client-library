...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ThingCreateResponseProperties();
  });
  ...
  describe('ThingCreateResponseProperties', function() {
    it('should create an instance of ThingCreateResponseProperties', function() {
      ...
      //var instane = new DigitalModelApiWip.ThingCreateResponseProperties();
      //expect(instance).to.be.a(DigitalModelApiWip.ThingCreateResponseProperties);
    });

    it('should have the property cpu (base name: "cpu")', function() {
      // uncomment below and update the code to test the property cpu
      //var instance = new DigitalModelApiWip.ThingCreateResponseProperties();
