...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instane = new MqttApiReference.ErrorResponse();
      //expect(instance).to.be.a(MqttApiReference.ErrorResponse);
    });

    it('should have the property error (base name: "error")', function() {
      // uncomment below and update the code to test the property error
      //var instance = new MqttApiReference.ErrorResponse();
