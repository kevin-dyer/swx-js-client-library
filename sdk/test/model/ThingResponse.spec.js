...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ThingResponse();
  });
  ...
  describe('ThingResponse', function() {
    it('should create an instance of ThingResponse', function() {
      ...
      //var instane = new DigitalModelApiWip.ThingResponse();
      //expect(instance).to.be.a(DigitalModelApiWip.ThingResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new DigitalModelApiWip.ThingResponse();
