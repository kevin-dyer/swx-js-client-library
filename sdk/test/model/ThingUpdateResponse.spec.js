...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.ThingUpdateResponse();
  });
  ...
  describe('ThingUpdateResponse', function() {
    it('should create an instance of ThingUpdateResponse', function() {
      ...
      //var instane = new MqttApiReference.ThingUpdateResponse();
      //expect(instance).to.be.a(MqttApiReference.ThingUpdateResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MqttApiReference.ThingUpdateResponse();
