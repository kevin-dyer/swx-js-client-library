...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.CreateLabelRelation();
  });
  ...
  describe('CreateLabelRelation', function() {
    it('should create an instance of CreateLabelRelation', function() {
      // uncomment below and update the code to test CreateLabelRelation
      //var instane = new MqttApiReference.CreateLabelRelation();
      //expect(instance).to.be.a(MqttApiReference.CreateLabelRelation);
    });
    ...
    it('should have the property entityType (base name: "entity_type")', function() {
      ...
      //var instance = new MqttApiReference.CreateLabelRelation();
