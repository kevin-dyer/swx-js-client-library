...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalModelApiWip.ThingCreateResponseCredentials();
  });
  ...
  describe('ThingCreateResponseCredentials', function() {
    it('should create an instance of ThingCreateResponseCredentials', function() {
      ...
      //var instane = new DigitalModelApiWip.ThingCreateResponseCredentials();
      //expect(instance).to.be.a(DigitalModelApiWip.ThingCreateResponseCredentials);
    });

    it('should have the property http (base name: "http")', function() {
      // uncomment below and update the code to test the property http
      //var instance = new DigitalModelApiWip.ThingCreateResponseCredentials();
