...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MqttApiReference.CreateMQTTLabelCredentialsResponse();
  });
  ...
  describe('CreateMQTTLabelCredentialsResponse', function() {
    it('should create an instance of CreateMQTTLabelCredentialsResponse', function() {
      ...
      //var instane = new MqttApiReference.CreateMQTTLabelCredentialsResponse();
      //expect(instance).to.be.a(MqttApiReference.CreateMQTTLabelCredentialsResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MqttApiReference.CreateMQTTLabelCredentialsResponse();
